...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Get the selected language from session storage
            const selectedLanguage = sessionStorage.getItem('selectedLanguage') || 'this language';
            
            // Update the question text with the selected language
            selectedLanguageSpan.textContent = selectedLanguage;
            ...
            options.forEach(option => {
                option.addEventListener('click', function() {
                    ...
                    selectedOption = this.getAttribute('data-reason');
            ...
            // Ensure progress increases only on 'Continue' submission
            continueBtn.addEventListener('click', function(event) {
                event.preventDefault(); // Prevent default button behavior

                // Update progress to 75% on continue
                ...
                setTimeout(() => {
                    window.location.href = 'time.php'; // Replace with the actual next page
                }, 500);
            });
